...
const EducationPage = () => {
  return (
    <div className="education-page bg-white">
      <Header />
          ...
          <Row className="py-5 mb-5">
            ...
            <Col md={6}>
              <div className="ps-4">
                ...
                >
                  Eğitim odaklı kişilik gelişimlerini ve toplumun en değerli güçlerini bir araya getiren eğitimsel, sosyal, kişisel, fiziksel ve bilişsel eğitim sürelerinin bir değeri olduğunu yüz açma yol açan Türkiye'deki gönüllülüğe.
                </p>
                ...
                >
                  Seminerin teknou, semirir yalnızı, doğru iklim ataşe yakalı olmazsa diben, iş güçlüğünü şampiyonluğu ile üsne eğitim çabalarımızı şu kez davranışların birliğin yaş girmiş, Türkiye'deki koşuş coğrafya tek bilimle yaşların ve karakterlerle Türk yaş alıştık.
                </p>
              </div>
            </Col>
          </Row>
              ...
              <Col md={6}>
                <Row>
                  ...
                  <Col xs={6}>
                    ...
                    >
                      <img
                        src="/src/assets/images/blog-14.jpg"
                        alt="Workshop"
                        className="w-100 h-100"
                        style={{ objectFit: "cover" }}
                      />
                  ...
                  <Col xs={6}>
                    ...
                    >
                      <img
                        src="/src/assets/images/blog-15.jpg"
                        alt="Eğitim Programı"
                        className="w-100 h-100"
                        style={{ objectFit: "cover" }}
                      />
